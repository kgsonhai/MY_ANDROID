...
public class DonHang2_Adapter extends RecyclerView.Adapter<DonHang2_Adapter.ViewHolder> {

    ArrayList<DonHang> donHangArrayList;
    Context context;
    int tongtien = 0;

    public DonHang2_Adapter(ArrayList<DonHang> donHangArrayList, Context context) {
    ...
    @NonNull
    @Override
    public DonHang2_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DonHang2_Adapter.ViewHolder holder, int position) {
