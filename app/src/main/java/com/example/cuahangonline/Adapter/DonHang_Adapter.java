            ...
            switch (vitri) {
                case 0:
                    btnHuyDon.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            CheckConnection.ShowToast_short(context, "Hủy đơn thành công");
                ...
                case 1:
                    btnHuyDon.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            context.startActivity(intent);
                            CheckConnection.ShowToast_short(context, "Hủy đơn hàng thành công");
                ...
                case 2:
                    btnHuyDon.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            CheckConnection.ShowToast_short(context,"Sản phẩm này đang được giao không thể hủy!!");
                        }
                    });
                    break;
